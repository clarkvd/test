		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=119023&x=SEKXLEN&y=SEKYLEN&cbuster=1743526914',
					origQString: 's=119023',
					placementId: 119023,
					x: 640,
					y: 440,
					videoType: 'flow',
